        ...
        for sentence in script_sentences:
            ...
            for entity in doc.ents:
                if entity.label_ =="PERSON":
                    ...
                    first_name = "Homer" if first_name == "Homie" else first_name # Replace "Homie" with "Homer"
                    # Exclude "Simpson" and "Mmm" as they are not first names
                    if first_name != "Simpson" and first_name != "Mmm":
                        ners.add(first_name)
